...
&& Tese de doutorado: trabalho científico com mesmo formato que a dissertação de mestrado mas com maior dificuldade e profundidade. Deve ser original e substancial~\cite{Comer2008dissertation}. Exige a resolução de um problema mais difícil e mais contribuições signifiativas~\cite{Chinnek1999thesis}.
\end{easylist}
